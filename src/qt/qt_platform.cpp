...
{
    const QString releaseKey = QString(release_shortcut).isEmpty() ? MOUSE_CAPTURE_KEYSEQ : KeyShortcuts::portableToNativePrintableList(QString(release_shortcut)).join(SHORTCUT_JOIN_STRING);
